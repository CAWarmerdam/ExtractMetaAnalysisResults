...
workflow FINEMAPPING {
    ...
    main:
        ...
        if (model == "susie") {
          ...
          finemapped_split_ch = RunCarmaSusieFineMapping(empirical_parquet_ch, permuted_parquet_ch, variant_reference_ch, uncorrelated_genes_ch, loci_bed_collated_ch, ld_type, max_i2, no_adjust_sumstats).flatten().collect()
